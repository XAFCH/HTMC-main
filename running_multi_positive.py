...
def run_dataset(
    ...
    #     factor=0.5,  # 学习率降到原来的一半
    #     patience=2,  # val micro-F1 连续 2 个 epoch 没明显提升就降
    #     threshold=1e-3,  # 提升幅度太小就不算真正提升
    #     threshold_mode="rel",
    #     min_lr=1e-6,
    # )
...
def main():
    ...
    parser.add_argument(
        "--train_path",
        type=str,
        default="/Users/Research/HTMC/data/BGC/bgc_train.json",
    )
    parser.add_argument(
        "--val_path",
        type=str,
        default="/Users/Research/HTMC/data/BGC/bgc_val.json",
    )
    parser.add_argument(
        "--test_path",
        type=str,
        default="/Users/Research/HTMC/data/BGC/bgc_test.json",
    )
    parser.add_argument(
        "--taxonomy_path",
        type=str,
        default="/Users/Research/HTMC/data/BGC/bgc.taxonomy",
    )
    parser.add_argument(
        "--labels_path",
        type=str,
        default="/Users/Research/HTMC/data/BGC/labels.txt",
    )
